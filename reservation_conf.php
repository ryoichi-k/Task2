...
<body>
        ...
        <form action="" method="post">
            <h3>部屋：<?=$room_detail['name']?></h3>
            <h3>宿泊日：<?=$_POST['date']?></h3>
            <h3>人数：<?=$_POST['number']?>名様</h3>
            ...
            <input class="conf-submit" name="send" type="submit" value="登録完了" formaction="reservation_done.php"></p>
            <h3>お支払い総額：<?=$room_detail['price']?>円</h3>
        </form>
    <footer>
