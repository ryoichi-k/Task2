...
try {
    $model = new Model();
    $model->connect();
    $sql_room_name = 'SELECT * FROM room WHERE delete_flg = 0';
    $stmt = $model->dbh->query($sql_room_name);
...
<meta name="viewport" content="width=device-width,initial-scale=1"><!--スマホ用に見れるように-->
...
　  </div>
      ...
      <div class="roomA">
        <img src="./img/roomA.jpg">
          <div class="roomA-text">
            <h3>和室個室　トイレ＆洗面付き</h3>
            <p>１名様：￥6,500<br>
              ２名様：￥10,000（1名様￥5,000）<br>
              ３名様：￥13,200（1名様￥4,400）<br>
              ４名様：￥15,600（1名様￥3,900）</p>
          </div>
      </div>

      <div class="roomB">
        <img src="./img/roomB.jpg">
          <div class="roomB-text">
            <h3>和室個室　トイレ共同</h3>
            <p>１名様：￥5,500<br>
              ２名様：￥8,800（1名様￥4,400）<br>
              ３名様：￥11,700（1名様￥3,900）<br>
              ４名様：￥14,800（1名様￥3,700）</p>
          </div>
        </div>

        <div class="dormitory">
          <img src="./img/dormitory.jpg">
            <div class="dormitory-text">
              <h3>和室ドミトリー　トイレ共同</h3>
              <p>１名様：￥3,100<br>
                5名様まで１部屋貸切：¥15,500</p>
            </div>
